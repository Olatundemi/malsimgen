                                             ...
                                             init_EIR, model_param_list, state_check = 0)
{
  ...
  age02 <- which(age_vector > 2)[1] - 2  # index of age vector before 2 years #--*NEW*--#
  age10 <- which(age_vector > 10)[1] - 1  # index of age vector at age is 10 years #--*NEW*--#
# #print("ageupto2")
#   print(age02)
#   print("ageupto10")
# print(age10)
#
#   indices_between_age02_and_age10 <- age02:age10
#   print("Indices between age02 and age10 (inclusive):")
#   print(indices_between_age02_and_age10)
  ...
  res <- list(init_S = S_eq, init_T = T_eq, init_D = D_eq, init_A = A_eq, init_U = U_eq,
              ...
              den = den, age59 = age59, age05 = age05, #ageupto10=ageupto10, ageupto2 = ageupto2, #--*NEW*--#
              age10=age10, age02=age02,
              pi = pi,
